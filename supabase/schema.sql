...
CREATE TABLE public.check_history (
    ...
    CONSTRAINT check_status_valid CHECK (status IN ('operational', 'degraded', 'failed')),
...
COMMENT ON COLUMN public.check_history.status IS '状态: operational, degraded, failed';

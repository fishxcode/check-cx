...
const REQUIRED_SITE_SETTINGS = [
  ...
  {
    key: "global_group_health.metric.success_rate",
    value: "true",
    description: "分组卡片是否展示「成功率」指标",
    editable: true,
    value_type: "boolean",
  },
  {
    key: "global_group_health.metric.avg_use_time",
    value: "true",
    description: "分组卡片是否展示「平均耗时」指标",
    editable: true,
    value_type: "boolean",
  },
  {
    key: "global_group_health.metric.cache_rate",
    value: "true",
    description: "分组卡片是否展示「缓存率」指标",
    editable: true,
    value_type: "boolean",
  },
  {
    key: "global_group_health.metric.cache_request_rate",
    value: "true",
    description: "分组卡片是否展示「缓存效率」指标",
    editable: true,
    value_type: "boolean",
  },
  {
